package com.example.yeshiyuan.mycsdn.dao;
...
public class NewsItemDao {
    ...
    public void add(NewsItem newsItem) {
        ...
        String sql = "insert into tb_newsItem (title,link,date,imgLink,content,newstype) " +
                "values(?,?,?,?,?,?) ;";
    ...
    public List<NewsItem> list(int newsType, int currentPage) {
        ...
        try {
            ...
            String sql = "select title,link,date,imgLink,content,newstype " +
                    "from tb_newsItem where newstype = ? limit ? ,? ";
